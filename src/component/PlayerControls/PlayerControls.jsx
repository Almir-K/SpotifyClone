...
const PlayersControls = ({ is_paused, duration, progress, player }) => {
	...
	return (
		<Stack direction={'column'} spacing={2} justify="center" alignItems={'center'} sx={{ width: '100%' }}>
			<Stack spacing={1} direction={'row'} justifyContent={'center'} alignItems={'row'}>
				<IconButton
					size="small"
			...
			<Stack spacing={2} direction={'row'} justifyContent={'center'} alignItems={'center'} sx={{ width: '74%' }}>
